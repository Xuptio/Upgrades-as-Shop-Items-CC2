...
function imgui_item_description_upgrade(ui, vehicle, item_data, is_inventory, is_active)
    local window = ui:get_window()
    local region_w, region_h = ui:get_region()
    ui:spacer(2)
    ...
    if is_inventory then
        ...
        update_ui_image(math.floor(cx - 10), cy, atlas_icons.column_time, color_grey_dark, 0)
        update_ui_text(math.floor(cx + 1), cy, item_data.time .. "s", math.floor(icon_w) - 15, 0, color_grey_dark, 0)
        cx = cx + icon_w
        ...
        update_ui_image(math.floor(cx - 5), cy, atlas_icons.column_difficulty, color8(255, 165, 0, 255), 0)
        --update_ui_text(math.floor(cx + 16), cy, item['shieldcost'], math.floor(icon_w) - 15, 0, col, 0)
        update_ui_text(math.floor(cx + 4), cy, item_data['shieldcost'],  -15, 0, color8(255, 165, 0, 255), 0)
    end
